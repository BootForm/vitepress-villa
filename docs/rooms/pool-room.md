---
layout: page
name: Swimming Pool Room
title: Swimming Pool Room
description: Right by the pool and the gym, for guests who want to be near both.
image: /rooms/pool-room.jpg
sleeps: 3
bed: King-size bed plus a sofa bed
view: Pool view
order: 5
---
...
The only room with an extra sofa bed, which makes it the default for a family of three or a
parent travelling with a younger child. Right next to the pool and the gym.

**In the room.** A king-size bed plus a sofa bed, a private en-suite bathroom, air conditioning, a
flat-screen TV, and the shortest walk to the pool of any room in the villa.
