...
name: Prince Room
title: Prince Room
description: Steps from the pool, for whoever wants to be first in the water in the morning.
image: /rooms/prince-room.jpg
sleeps: 2
bed: King-size bed
view: Pool view
order: 3
...
The closest bedroom to the pool, with a door that opens straight onto the terrace. Good for
whoever's first up and first in the water.

**In the room.** A king-size bed, a private en-suite bathroom, air conditioning, a flat-screen TV,
and direct terrace access to the pool deck.
